...
linear = np.load('png/linear_assign_bkt_6_7_3_0.1_0.5_1.5_1_05041749.npy', allow_pickle=True).item()
rs = np.load('png/baseline_bkt_6_7_3_0.1_0.5_1.5_1_05041758.npy', allow_pickle=True).item()
